            ...
            >
              <div>
                <div className="mb-2 flex items-start justify-between gap-2">
                  <h3 className="font-display text-base font-semibold text-hub-ink">
                    {p.title}
                  </h3>
                  <Badge tone="approved">
                ...
                <p className="text-xs text-hub-indigo">
                  {p.company_name}{" "}
                  {p.verified_status && (
                    <span className="text-hub-emerald">· verified</span>
                  )}
                </p>
                <p className="mt-2 text-sm text-hub-muted line-clamp-3">
                  {p.description}
                </p>
                <p className="mt-3 text-xs uppercase tracking-widest text-hub-indigo/80">
                  Open to
                </p>
                <div className="mt-1">
                  <SkillChips skills={p.eligible_courses} />
                </div>
