...
import { Card, Field, Input, Textarea, Button, SectionHeading, Spinner, EmptyState, Badge, Chips } from '../../components/ui.jsx';

const emptyForm = { title: '', description: '', eligibleCourses: '', slotsOpen: '', durationMonths: '', openDate: '', closeDate: '' };
    ...
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      <Card className="mb-6 animate-riseIn">
        ...
        <form onSubmit={handleCreate} className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <Field label="Eligible courses" hint="Comma-separated — this is what students are matched on, e.g. 'Computer Science, Informatics'">
              <Input required value={form.eligibleCourses} onChange={set('eligibleCourses')} placeholder="Computer Science, Informatics" />
            </Field>
          </div>
            ...
            <Card key={p.program_id} className="animate-fadeUp">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-xs uppercase tracking-widest text-hub-indigo/80">Eligible courses</p>
                  <div className="mt-1"><Chips items={p.eligible_courses} /></div>
                </div>
