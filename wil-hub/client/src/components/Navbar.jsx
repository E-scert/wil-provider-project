      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  ...
                  isActive
                    ? "bg-hub-indigo/15 text-white"
                    : "text-hub-muted hover:text-hub-ink hover:bg-hub-panel2",
                ].join(" ")
              }
            >
              {l.label}
        ...
        <div className="flex items-center gap-2">
          <span className="hidden items-center gap-2 rounded-full border border-hub-line bg-hub-panel px-3 py-1.5 text-xs text-hub-muted sm:inline-flex">
            ...
            {displayName} ·{" "}
            <span className="text-hub-indigo">{ROLE_LABEL[role]}</span>
          </span>
          <button
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              [
                ...
                isActive ? "bg-hub-indigo/15 text-white" : "text-hub-muted",
              ].join(" ")
            }
          >
            {l.label}
