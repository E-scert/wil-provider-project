    ...
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      {loading ? (
        ...
        <div className="stagger flex flex-col gap-3">
          {apps.map((a) => (
            <Card key={a.app_id} className="animate-fadeUp flex items-center justify-between gap-4">
              <div>
                <p className="font-display text-sm font-semibold text-white">{a.wil_program?.program_name}</p>
                <p className="text-xs text-tut-gold">{a.wil_program?.company?.comp_name}</p>
