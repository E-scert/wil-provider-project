    ...
    <div className="flex min-h-[calc(100vh-0px)] items-center justify-center px-5 py-10">
      <div className="w-full max-w-sm animate-riseIn">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1.5 text-sm text-white/45">Log in to your account.</p>
        </div>
        ...
        <Card>
          ...
          <p className="mt-4 text-center text-xs text-white/35">
            New here?{' '}
            <Link to="/signup/student" className="text-tut-red underline underline-offset-2">Sign up as a student</Link>
            {' '}or{' '}
            <Link to="/signup/company" className="text-tut-red underline underline-offset-2">as a company</Link>.
          </p>
        </Card>

        <p className="mt-6 text-center">
          <Link to="/programs" className="text-xs text-white/30 underline underline-offset-2 hover:text-white/50">
